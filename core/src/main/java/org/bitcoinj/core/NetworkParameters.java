    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            byte[] bytes = Utils.HEX.decode
                    ("04ffff001d01043b7368616e676861692073746f636b20696e64657820636c6f73656420617420323334332e35372c206f6e203234746820536570742e2c2032303134");
            t.addInput(new TransactionInput(n, t, bytes));
            ByteArrayOutputStream scriptPubKeyBytes = new ByteArrayOutputStream();
            Script.writeBytes(scriptPubKeyBytes, Utils.HEX.decode
                    ("049e02fa9aa3c19a3b112a58bab503c5caf797972f5cfe1006275aa5485a01b48f9f648bc5380ee1e82dc6f474c8e0f7e2f6bbd0de9355f92496e3ea327ccb19cc"));
            scriptPubKeyBytes.write(ScriptOpCodes.OP_CHECKSIG);
//            t.addOutput(new TransactionOutput(n, t, FIFTY_COINS, scriptPubKeyBytes.toByteArray()));
            t.addOutput(new TransactionOutput(n, t, Coin.valueOf(COIN.value * 100), scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.
